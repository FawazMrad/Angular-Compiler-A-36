...
@Component({
  selector: 'app-root',    ///////Here the error cause here the selector 'app-root' is duplicated
  standalone: true,
...
export class AppComponent {
  ...
  products = [
    ...
    { id: 2, name: 'Lenovo Legion 6', description: 'Model 2025', price: 1550, image: 'shortened-image-url' },
